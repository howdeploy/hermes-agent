...
def _export_dump_excluding_session_vars(
    ...
    return (
        ...
        # HERMES_SINGLE_QUERY_SESSION / HERMES_CRON_SESSION are bridged
        # per-session markers (gateway.session_context._VAR_MAP) without a
        # wildcard-safe prefix of their own; unset them by name.
